...
BULK_EXECUTION_MAX_TARGETS = config_int("BULK_EXECUTION_MAX_TARGETS", 500)
...
DATA_UPLOAD_MAX_NUMBER_FILES = config_int("DATA_UPLOAD_MAX_NUMBER_FILES", 1000)
